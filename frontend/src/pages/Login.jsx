  ...
  return (
    <form className='flex flex-col items-center w-[90%] sm:max-w-96 m-auto mt-14 gap-4 text-gray-800' onSubmit={handleSubmit}>
      ...
      <div className="w-full flex justify-between text-sm -mt-2">
        ...
        {currentState === 'Login'? <p className='cursor-pointer hover:border-b' onClick={()=>setCurrentState("Sign up")}>Create Account</p> : <p className='cursor-pointer hover:border-b' onClick={()=>setCurrentState('Login')}>Login Here</p> }
